        ...
        <div className='flex-1 h-80 border shadow-sm bg-white rounded-xl'>
            <div className='font-roboto text-[#607d8b] flex flex-col p-5 gap-2'>
                ...
                <div className='flex flex-col gap-1 p-2 border rounded-lg shadow-sm'>
                    ...
                    <LinearProgress className='rounded-sm' variant='determinate' value={12} color='success' />
                </div>
                <div className='flex flex-col gap-1 p-2 border rounded-lg shadow-sm'>
                    <div className='flex justify-between'>
                    ...
                    <LinearProgress className='rounded-sm' variant='determinate' value={56} color='success' />
                </div>
                <div className='flex flex-col gap-1 p-2 border rounded-lg shadow-sm'>
                    <div className='flex justify-between'>
                    ...
                    <LinearProgress className='rounded-sm' variant='determinate' value={80} color='success' />
                </div>
