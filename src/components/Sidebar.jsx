  ...
  return (
    <div className="w-[26%] h-full rounded-2xl border border-[#cfd8dc] bg-white shadow-sm">
      <div className="font-roboto-bold relative flex flex-col h-full items-center py-4">
        ...
        <h1 className="font-bold py-3 text-lg text-[#607d8b]">
          {userType === 1 ? "Admin" : "Registrar"} Dashboard
        </h1>
          ...
          {items.map((item, i) => {
            return (
              ...
              >
                <div
                  className={`${
                    i === screen ? "text-white bg-[#49a54d]" : "text-[#607d8b]"
                  } h-full flex flex-row items-center px-6 gap-4 rounded-lg`}
                >
                  {item.icon}
        ...
        <div className="absolute bottom-2 w-full h-12 px-3 cursor-pointer">
          <div
            ...
            className="cursor-pointer flex flex-row text-[#607d8b] px-6 gap-4"
          >
